@extends('visitors.layouts.visitors',['title' => 'commercial-gi-wire'])
@section('content')
<!--=========Banner Start============-->
<div class="inner-pages-bnr">
    <img src="images/manufacturing-banner.jpg" class="img-responsive" alt="Manufacturing-banner-image">
    <div class="banner-caption">
        <h1>Commercial GI Wire</h1>
        <ul class="breadcumb">
            <li><a href="{{ route('home') }}">Home</a> - </li>
            <li>Commercial GI Wire</li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    ...
                    <div class="special-text">
                        <h3>Commercial GI Wire</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading Commercial GI Wire Manufacturers in Rajasthan. commercial GI wire, also known as
                        galvanized iron wire, is the end of the galvanization process. The wire is rust-resistant because of an
                        anti-rust-protected zinc metal covering. commercial galvanized iron wire is not only inexpensive and durable but also
                        simple to set up. It is a versatile choice for a variety of tasks since it can be cut and molded to meet almost any
                        requirement.
                    </div>
                </div>
                <div>
                    <p>
                       As a leading Commercial GI Wire Manufacturer in Dholpur. Your homes and properties are protected by commercial GI wires.
                    They can be utilized as security fences around residences and workplaces. Barbed wire, chain link fencing, and
                    concertina wire are examples of this. Homes are protected from burglars and animals by the concertina wire's extremely
                    sharp edges. The commercial GI wire is useful for securing building supplies. Paintings and wall projections can be
                    supported adequately because of their outstanding strength.
                    </p>
                </div>
                <br>
                <br>
                <div>
                    <p>
                       As one of the best Commercial GI Wire Suppliers in India, The ability of commercial galvanized iron wire to resist rust
                    and corrosion is one of its greatest benefits. Because of this, it is the best option for outdoor applications where
                    other kinds of metal wires would soon degrade due to the weather.
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                <ul class="category-list">
                    ...
                    <li><a href="{{ route('commercial-gi-wire') }}" class="active-category">Commercial GI Wire</a></li>
