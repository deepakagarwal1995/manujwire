@extends('visitors.layouts.visitors',['title' => 'gi-welded-wire-mesh'])
@section('content')
<!--=========Banner Start============-->
<div class="inner-pages-bnr">
    <img src="images/manufacturing-banner.jpg" class="img-responsive" alt="Manufacturing-banner-image">
    <div class="banner-caption">
        <h1>GI Welded Wire Mesh</h1>
        <ul class="breadcumb">
            <li><a href="{{ route('home') }}">Home</a> - </li>
            <li>GI Welded Wire Mesh</li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
    ...
    <div class="container">
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    <div class="special-img image_hover">
                        <img src="images\giwire.jpg" class="img-responsive zoom_img_effect" alt="special-image">
                    </div>
                    <div class="special-text">
                        <h3>GI Welded Wire Mesh</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading GI Welded Wire Mesh Manufacturers in Rajasthan. We are a producer dedicated to
                        providing our customers with a reliable selection of galvanized iron welded wire of the highest quality. To accommodate
                        and meet the unique needs of our recognized clients who require our s, the provided GI welded Wires variety is available
                        in the customized form of various sizes and shapes. Additionally, the available wire range is created and developed
                        in-house.
                        </p>
                    </div>
                </div>
                <div>
                    <p>
                       As a trusted GI Welded Wire Mesh Manufacturer in Dholpur, We are an important supplier and manufacturer of GI Welded
                    Wire Mesh. Steel wire of a high caliber was used to create this mesh. To provide a nice finish, the supplied mesh goes
                    through electroplating and a hot zinc dip. In addition to its numerous other applications, this mesh is occasionally
                    used in zoos to construct animal cages or walls.
                    </p>
                </div>
                <br>
                <br>
                <div>
                    <p>
                     Our name is renowned among the top-notch GI Welded Wire Mesh Suppliers in India, we are here to meet your orders without
                    any delays. Get our instant support to buy customized designs.
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                ...
                <li><a href="{{ route('gi-welded-wire-mesh') }}" class="active-category">GI Welded Wire Mesh</a></li>
