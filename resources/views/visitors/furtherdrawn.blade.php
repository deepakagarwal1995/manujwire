@extends('visitors.layouts.visitors',['title' => 'further-drawn-wire'])
@section('content')
<!--=========Banner Start============-->
<div class="inner-pages-bnr">
    <img src="images/manufacturing-banner.jpg" class="img-responsive" alt="Manufacturing-banner-image">
    <div class="banner-caption">
        <h1>Further Drawn Wire</h1>
        <ul class="breadcumb">
            <li><a href="{{ route('home') }}">Home</a> - </li>
            <li>Further Drawn Wire</li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
    ...
    <div class="container">
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    <div class="special-img image_hover">
                        <img src="images\fwire.jpg" class="img-responsive zoom_img_effect" alt="special-image">
                    </div>
                    <div class="special-text">
                        <h3>Further Drawn Wire</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading Further Drawn Wire Manufacturers in Rajasthan. The further drawn wire that we
                        manufacture best for construction purposes. All the wires that we manufacture are produced under the safety guidelines
                        that all the wires must meet in order to be fit for usage. So if you are concerned about the safety issues with the
                        wires then you can trust us without any problem.
                        </p>
                    </div>
                </div>
                <div>
                    <p>
                      As a leading Further Drawn WIre Manufacturer in Dholpur, Our main concern is to provide our customers with the best
                    quality wires possible under the simplest range. There are a wide variety of options to choose from. Depending upon your
                    usage we are loaded with all kinds of wires.
                    </p>
                </div>
                <br>
                <br>
                <div>
                    <p>
                     As one of the best Further Drawn Wire Suppliers in India, The further-drawn wires that we supply hold the best tensile
                    strength possible and is fit for all heavy tasks.
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                ...
                <li><a href="{{ route('further-drawn-wire') }}" class="active-category">Further Drawn Wire</a></li>
