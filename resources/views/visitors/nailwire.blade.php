@extends('visitors.layouts.visitors',['title' => 'nail-wire'])
@section('content')
<!--=========Banner Start============-->
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    ...
                    <div class="special-text">
                        <h3>Nail Wire</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading Nail Wire manufacturers in Rajasthan, Wire nails are nails that are crafted from
                        coils of wire. It is a regular variety of nail that is easily accessible in the market. The majority of the time, wire
                        nails are used in the home to attach wooden items and other crafts materials. The wire nail machine is the most typical
                        method of producing wire nails. It is a semi-automatic machine that produces a lot of wire nails at once.
                    </div>
                </div>
                <div>
                    <p>
                       As a leading Nail wire manufacturer in Dholpur, Nail wires are versatile and durable. They are therefore utilized in a
                    variety of industries in addition to house projects. Usually, wire nails can be used to secure items to hardwood
                    surfaces, wooden walls, wooden floors, and cardboard in any situation that calls for fastenings.
                    </p>
                </div>
                <br>
                <br>
                <div>
                    <p>
                        As one of the best Nail wire suppliers in India, For their versatility, our Wire nails are quite well known. They are
                        therefore utilized in a variety of industries in addition to home projects. Usually, wire nails can be used to secure
                        items to hardwood surfaces, wooden walls, wooden floors, and cardboard in any situation that calls for fastenings
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                <ul class="category-list">
                    ...
                    <li><a href="{{ route('nail-wire') }}" class="active-category">Nail Wire</a></li>
