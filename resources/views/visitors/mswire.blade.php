@extends('visitors.layouts.visitors',['title' => 'ms-welded-wire-mesh'])
@section('content')
<!--=========Banner Start============-->
<div class="inner-pages-bnr">
    <img src="images/manufacturing-banner.jpg" class="img-responsive" alt="Manufacturing-banner-image">
    <div class="banner-caption">
        <h1>MS Welded Wire Mesh</h1>
        <ul class="breadcumb">
            <li><a href="{{ route('home') }}">Home</a> - </li>
            <li>MS Welded Wire Mesh</li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    <div class="special-img image_hover">
                        <img src="images\nailwire.jpg" class="img-responsive zoom_img_effect" alt="special-image">
                    </div>
                    <div class="special-text">
                        <h3>HB Wire</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading MS Welded Wire Mesh Manufacturers in Rajasthan. Welded wire mesh, also known as
                        welded wire fabric or weld mesh, is a grid that has been electrically joined and is made up of a number of parallel long
                        wires with exact spacing that are joined to cross wires at the necessary distances. It comes in a range of shapes and
                        sizes. It is generally utilized in the transportation, horticulture, industrial, agricultural, and food purchasing
                        industries. Additionally, it is utilized in mining, landscaping, machine safety, and other decorations. Additionally,
                        welded wire fabric (WWF) is occasionally utilized in reinforced concrete, particularly for slabs.is their
                            principal advantage.
                    </div>
                </div>
                <div>
                    <p>
                        As a leading MS Welded Wire Mesh Manufacturer in Dholpur, Weld mesh is the name given to a type of barrier fencing that
                        is made of steel wire in the shapes of square or rectangular mesh and is joined at each intersection. According to the
                        requirements of our clients, we produce weld mesh in a wide range of sizes and materials. Because the bars are welded to
                        a mat, they do not move when the concrete is poured, assuring that the bars are in the right spot. Technology is used in
                ...
                <div>
                    <p>
                       As one of the best MS Welded Wire Mesh Suppliers in India, Each section of wire is checked for strength properties
                    throughout the hard drawing process, making the material more dependable.
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                <ul class="category-list">
                    ...
                    <li><a href="{{ route('ms-welded-wire-mesh') }}" class="active-category">MS Welded Wire Mesh</a></li>
