@extends('visitors.layouts.visitors',['title' => 'hot-dip-galvnized-wire'])
@section('content')
<!--=========Banner Start============-->
<div class="inner-pages-bnr">
    <img src="images/manufacturing-banner.jpg" class="img-responsive" alt="Manufacturing-banner-image">
    <div class="banner-caption">
        <h1>Hot Dip Galvanized Wire</h1>
        <ul class="breadcumb">
            <li><a href="{{ route('home') }}">Home</a> - </li>
            <li>Hot Dip Galvnized Wire</li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
            ...
            <div class="col-md-8 right-column" style="margin-top: -50px">
                ...
                <div class="specialization-cl">
                    <div class="special-img image_hover">
                        <img src="images\hotdipwire.jpg" class="img-responsive zoom_img_effect" alt="special-image">
                    </div>
                    <div class="special-text">
                        <h3>Hot Dip Galvanized Wire</h3>
                        <p class=" mar-btm20">BM Jain Steel Co. is one of the leading Hot Dip Galvanized Wire Manufacturers in Rajasthan. Hot dip galvanizing is a
                        procedure that coats the surface of the wire with zinc. This zinc coating on a wire prevents corrosion and lengthens the
                        's durability. Hot dip galvanized a cable is a solid option for outdoor or caustic applications where corrosion
                        protection is required. Due to the cheap initial cost and the high durability of galvanizing, hot dip galvanizing has
                        the lowest cost. Because of its versatility and cost-effectiveness, hot dip galvanizing is one of the best ways to
                        preserve the base metal.
                    </div>
                </div>
                <div>
                    <p>
                        As a leading Hot Dip Galvanized Wire Manufacturer in Dholpur, Steel that is underwater, embedded in the soil, or covered
                        in concrete is often protected via hot-dip galvanizing. Galvanized wire has a reputation for durability in all of these
                        conditions, despite the fact that the corrosion mechanisms and life span vary depending on the specific environment.
                    </p>
                </div>
                <br>
                <br>
                <div>
                    <p>
                        As one of the best Hot Dip Galvanized Wire Suppliers in India, the Maintenance expenses of these steel objects are
                        usually lower since our hot dip galvanized coatings are thicker, self-maintaining, and last longer than other options.
                        There are minimum, standardized coating thickness requirements. Therefore, coating durability is trustworthy and
                        predictable.
                    </p>
                </div>
                <br>
        ...
        <div class="col-md-4 left-column">
            <ul class="category-list">
                <ul class="category-list">
                    ...
                    <li><a href="{{ route('hot-dip-galvnized-wire') }}" class="active-category">Hot Dip Galvanized Wire</a></li>
